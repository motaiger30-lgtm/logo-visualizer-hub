...
export function Categories() {
  const pick = (slug: ProductSlug) => {
    window.dispatchEvent(new CustomEvent("urgent:set-product", { detail: { product: slug } }));
  };
    ...
    <section id="products" className="relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12">
          <div>
            <p className="text-xs uppercase tracking-[0.25em] text-accent">Products</p>
          ...
          <p className="max-w-md text-muted-foreground">
            Tap a product to load it into the designer below. Live pricing in EGP.
          </p>
        </div>
